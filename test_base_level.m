...
test_result('Object 1 position error', norm(final_p(1,:) - correct_p(1,:))/norm(correct_p(1,:))*100, '%', @le, 0.5);
test_result('Object 1 velocity error', norm(final_v(1,:) - correct_v(1,:))/norm(correct_v(1,:))*100, '%', @le, 0.5);
test_result('Object 2 position error', norm(final_p(2,:) - correct_p(2,:))/norm(correct_p(2,:))*100, '%', @le, 0.5);
test_result('Object 2 velocity error', norm(final_v(2,:) - correct_v(2,:))/norm(correct_v(2,:))*100, '%', @le, 0.5);     
